...
def serve_external_import(filename):
    external_import_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'public', 'external-import')
    return send_from_directory(external_import_dir, filename)
